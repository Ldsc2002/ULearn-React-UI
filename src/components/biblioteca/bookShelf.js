...
function Bookshelf(props) {
    ...
    //Subida de archivos a la biblioteca  -   <button id='subir_archivo' type="button" className="popUp-btn" onClick={() => uploadReady? finishUpload(): alert('No puede subir un archvio vacío')}>Terminar</button>
